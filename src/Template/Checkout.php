                ...
                <form method="post" accept-charset="utf-8" action="checkout" class="form" novalidate="novalidate">
                    <div class="frame">
                        ...
                        <div class="frame__contents">
                            <table class="order-summary">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img src="highres-assets/product.jpg" class="form-tumbnail_image" /></td>
                                        <td>Lorem Widget</td>
                                        <td>1</td>
                                    </tr>
                                </tbody>
                    ...
                    <div class="frame">
                        ...
                        <div class="frame__contents">
                            ...
                            <div class="form-field form-field--required">
                                <label class="form-field__label" for="billing_address_line1">Street Address 1: <span class="form-field__label-required"> (required)</span></label>
                                <div class="form-field__contents">
                            ...
                            <div class="form-field form-field--required">
                                <label class="form-field__label" for="billing_address_line2">Street Address 2:</span></label>
                                <div class="form-field__contents">
                                    <div class="textarea__container">
